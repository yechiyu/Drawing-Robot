...
$sideValueLaV = "la".$_POST['sideValueLaV'];
$out = '';
...
$sideValueLbV = "lb".$_POST['sideValueLbV'];
$out = '';
...
if (!socket_write($socket, $drawingit, strlen($drawingit))) {
  echo "socket_write() failed: reason: " . socket_strerror($socket) . "\n";
} else {
  echo "Message sent to server successful！\n";
  echo "The content to be sent is: $drawingit ";
}
